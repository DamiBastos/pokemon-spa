  ...
  function CustomToggle({ children, eventKey }) {
    ...
    return (
      <div className="container-button">
        <button className="menu-icon" type="button" onClick={decoratedOnClick}>
          {children}
        </button>
      </div>
    );
          ...
          <Accordion defaultActiveKey="0">
            ...
            <Accordion.Collapse eventKey="1">
              <div className="side-menu">
                ...
                >
                  <option className="select-option" value="button" disabled>
                    Order
                  </option>
                  <option className="select-option" value="all">
                    Default
                  </option>
                  <option className="select-option" value="asc">
                    Ascendente
                  </option>
                  <option className="select-option" value="desc">
                    Descendente
                  </option>
                </select>
                <select
                ...
                >
                  <option className="select-option" value="filter" disabled>
                    Filter type:
                  </option>

                  <option className="select-option" key={0} value="all">
                    All types
                  </option>
                  {allTypesFilt.map((el) => {
                    return (
            ...
            <div className="cards">
              {
                ...
                currentPoke.length > 0 ? (
                  ...
                  <div className="container-waiting">
                    <div className="container-spinner-home">
